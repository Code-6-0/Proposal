...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Pendekatan Terpadu} — Berbeda dengan platform yang hanya fokus pada satu aspek (misalnya hanya penjualan diskon atau hanya donasi), ResQfood mengintegrasikan seluruh rantai nilai \textit{food waste} mulai dari penilaian kelayakan makanan, penjualan surplus dengan harga dinamis, hingga pelacakan dampak lingkungan \cite{kusumawati2025mobile}\cite{mobilefoodwaste2024review}.
