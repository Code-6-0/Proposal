...
\begin{longtable}{@{} >{\RaggedRight}p{0.16\textwidth} >{\RaggedRight}p{0.14\textwidth} >{\RaggedRight}p{0.15\textwidth} >{\RaggedRight}p{0.15\textwidth} >{\RaggedRight}p{0.13\textwidth} >{\RaggedRight}p{0.13\textwidth} @{}}
...
\midrule
\endfirsthead
\multicolumn{6}{l}{\small\textit{(Tabel \ref{tab:kompetitor} dilanjutkan)}} \\
\toprule
\textbf{Aspek / Fitur}
  & \textbf{Savora}
  & \textbf{Too Good To Go}
