...
Berikut adalah perbandingan ResQfood dengan platform serupa yang sudah ada di pasar \cite{mobilefoodwaste2024review}\cite{kusumawati2025mobile}:
...
Food Trust Index & \checkmark & \ding{55} & \ding{55} & \ding{55} \\
Donasi Manual & \checkmark & \checkmark & \ding{55} & \ding{55} \\
Tracking Real-time & \checkmark & \ding{55} & \checkmark & \checkmark \\
Carbon Impact Tracking & \checkmark & \ding{55} & \checkmark & \ding{55} \\
Rating \& Ulasan & \checkmark & \checkmark & \checkmark & \checkmark \\
