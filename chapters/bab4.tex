...
Berikut adalah perbandingan Savora dengan platform serupa yang sudah ada di pasar \cite{mobilefoodwaste2024review}\cite{kusumawati2025mobile}:
...
\toprule
\textbf{Fitur} & \textbf{Savora} & \textbf{FoodCycle} & \textbf{Too Good To Go} & \textbf{HappyFresh} \\
\midrule
