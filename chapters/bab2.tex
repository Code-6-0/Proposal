...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Achievable (Dapat Dicapai)} : Menerapkan fitur \textit{Food Eligibility Assessment}, \textit{Dynamic Pricing}, dan \textit{Food Trust Index} yang telah terbukti efektif dalam studi literatur \cite{kusumawati2025mobile}\cite{qlearning2026pricing} dan best practices platform serupa.
